    ...
    showDialog(
      ...
      builder: (context) {
        return AlertDialog(
          ...
          actions: [
            ElevatedButton(
              child: Text('OK', style: HMSTextStyle.setTextStyle()),
              onPressed: () {
  ...
  static Future<String> showInputDialog({
    ...
    String answer = await showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        actions: [
          ElevatedButton(
            child: Text('Cancel', style: HMSTextStyle.setTextStyle()),
            onPressed: () {
              Navigator.pop(context, '');
            },
          ),
                          ...
                          children: [
                            ...
                            Checkbox(
                              ...
                              onChanged: (bool? value) {
                                ...
                                } else if (selectedRoles.contains(
                                  roles[index],
                                )) {
              ...
              Expanded(
                child: ElevatedButton(
                  ...
                  onPressed: () => {
                    ...
                    if (leaveRoom) {meetingStore.leave()},
                    Navigator.pop(context),
                  },
                  child: Padding(
                    padding: const EdgeInsets.symmetric(
